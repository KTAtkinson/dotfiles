...
# Set color according to git status
function git_color {
    ...
    if [[ $git_status =~ "Changes not staged for commit" || $git_status =~ "Untracked files" ]]; then
        ...
        echo -e $COLOR_GREEN
    elif [[ $git_status =~ "Your branch is ahead of" || $git_status =~ "Your branch is behind" ]]; then
        echo -e $COLOR_YELLOW
    else
        echo -e $COLOR_BLUE
    fi
...
export PS1="\[\e[0;33m\]\W \[\$(git_color)\]\$(parse_git_branch)\[\033[00m\]\[\e[0;33m\]$\[\e[m\] "

# make ls -l by default
LS_COLORS=$LS_COLORS:'di=1;32:' ; export LS_COLORS
export LS_OPTIONS='-ltr --color=auto'
alias ls='ls $LS_OPTIONS'
source <(kubectl completion bash)
source <(minikube completion bash)

# The next line updates PATH for the Google Cloud SDK.
# if [ -f '/home/katie/src/google-cloud-sdk/path.bash.inc' ]; then source '/home/katie/src/google-cloud-sdk/path.bash.inc'; fi
...
# The next line updates PATH for the Google Cloud SDK.
if [ -f '/home/katie/src/google-cloud-sdk/path.bash.inc' ]; then . '/home/katie/src/google-cloud-sdk/path.bash.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/katie/src/google-cloud-sdk/completion.bash.inc' ]; then . '/home/katie/src/google-cloud-sdk/completion.bash.inc'; fi
